...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color primaryColor =  const Color.from(alpha: 1, red: 0.129, green: 0.588, blue: 0.953);
    final Color backgroundColor = const Color.fromRGBO(240, 248, 255, 1);
    final Color buttonColor =  const Color.from(alpha: 1, red: 0.129, green: 0.588, blue: 0.953);
